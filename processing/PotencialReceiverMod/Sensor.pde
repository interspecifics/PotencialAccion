...
public class Sensor {
  ...
  private short alpha,beta,gamma,delta;
  ...
  public Sensor(PVector _location, PVector _dimension, String _name) {
    ...
    alpha=0; //Basic Freqeuncy analysis of 4 different ranges
    beta=0;
    gamma=0;
    delta=0;
  ...
  public void setFrequency (short a, short b, short g, short d){
    alpha=a;
    beta=b;
    gamma=g;
    delta=d;
  ...
  public void sendOsc() {
    ...
    OscP5.flush(mMessage, oscOutAddress);
     ...
     mMessage.clear();
    mMessage.setAddrPattern(mAddrPatt+"b");
    mMessage.add(beta);
    OscP5.flush(mMessage, oscOutAddress);
